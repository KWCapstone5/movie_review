    ...
    for row in reader:
        ...
        for actor in actors:
            ...
            if actor_image_url:  # 이미지 URL이 있을 경우만 다운로드 시도
                download_image(actor_image_url, os.path.join(actor_folder, f"{actor}.jpg"))

        print(f"Downloaded images for {movie_title}")
